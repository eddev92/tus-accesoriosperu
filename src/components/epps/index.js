...
import { EppsProducts } from './../../constants/constants'
import MenuComponent from '../shared/menu';

const EppsComponent = ({ reference }) => {
  useEffect(() => {
    setTimeout(() => {
        setProductsInitial(EppsProducts)
    }, 1200)
})
const finalOrderObj = {
fullNames:'',
...
return (
<div className="App">
    <Alert message="Espacio hospitalario y seg. Industrial de TUSACCESORIOS PERU" type="info" closable={false} onClick={() => window.location.href="/"} />
            ...
            <div className="container">
                <div className="document gopro">
                    <div className="document__header">
                        ...
                        <h1 className="document__title">EPPS e INDUSTRIAL</h1>
