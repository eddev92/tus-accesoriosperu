...
import PayNowBlackRampsWishListForm from './pay-wishlist-form-blackramps';

const WishListBlackRampsModalComponent = ({ visible, closeModal = () => {}, products = [], payNow = () => {}, payNowUI, payFinishOrder = () => {},
...
<Modal
      ...
      > 
        ...
        <table id="table-wishlist">
          ...
          <br></br>
          {payNowUI && <PayNowBlackRampsWishListForm total={totalAmount} payNow={payFinishOrder} onFinish={onFinishWishList} responseSentOrderWishList={responseSentOrderWishList} backToShopFromWishList={backToShopFromWishList} />}
        </div>
        </Modal>
  )
}

export default WishListBlackRampsModalComponent;
