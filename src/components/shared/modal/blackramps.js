...
import { Form, Input, Button, InputNumber, Card, Row, Col, Table, Tag, Space, Modal, Alert } from 'antd';
import {urlWhatsApp,urlWhatsAppModified} from "../../../constants/routes"

function BlackRampsModalComponent({ finalOrder = null, quantitySelected = 1, setQuantity = null, backToShop = null, responseSentEmail = null, productSelected = {}, visible = false, closeModal = () => {}, onFinishFailed = () =>{}, onFinish = () =>{},
tailLayout, layout }) {
  ...
  if (productSelected) {
        ...
        >
          ...
          <Col span={16}>
            ...
            <Alert
                ...
                <br></br>
                <Tag color="blue">
                  <a target="_blank" href="https://wa.me/51966774697">https://wa.me/51966774697</a></Tag>
                {/* <br></br>
    ...
    >
              ...
              <Form.Item
                ...
                name="addressBlackRamps"
                rules={[{ required: true, message: 'Dirección de envío es requerido' }]}
              >
                <Input />
              </Form.Item>
              <Form.Item label="Cantidad">
            <Form.Item name="quantityItemsBlackRamps" noStyle >
            ...
            <span className="ant-form-text"> unidades</span>
              ...
              <Form.Item name={['clientCommentBlackRamps', 'comment']} label="Referencia de dirección:" rules={[{ required: true, message: 'Referencia es requerida' }]}>
...
export default BlackRampsModalComponent;
